# Generated by Django 5.1.3 on 2024-12-02 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', models.JSONField(blank=True, null=True, validators=[properties.models.validate_amenities])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=properties.models.upload_accommodation_image)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('accommodation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accommodation_images', to='properties.accommodation')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accommodations', to='properties.location'),
        ),
        migrations.CreateModel(
